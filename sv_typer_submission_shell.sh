...
# merged lumpy vcf to process

lumpy_vcf=bipolar.merged.lumpy.vcf
...
qsub -t 1-$number_bam -tc $JOBS svtyper_shell.sh -f $BAMs_to_PROCESS -b $bam_directory -l $lumpy_folder -s $scratch -v $lumpy_vcf
